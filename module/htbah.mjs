...
import { HtbahActor } from './documents/actor.mjs';
import { HtbahItem } from './documents/item.mjs';
...
Hooks.once('init', function () {
  ...
  Actors.registerSheet('htbah', HtbahActorSheet, {
    makeDefault: true,
    label: 'HTBAH.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('htbah', HtbahItemSheet, {
    makeDefault: true,
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.htbah.rollItemMacro("${data.uuid}");`;
