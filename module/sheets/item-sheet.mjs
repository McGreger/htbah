 ...
 * @extends {ItemSheetV2}
 */
export class HtbahItemSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static PARTS = {
    header: {
      template: 'systems/htbah/templates/item/header.hbs',
    },
    tabs: {
    ...
    attributesSpell: {
      template: 'systems/htbah/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
      template: 'systems/htbah/templates/item/effects.hbs',
    },
  };
